...
public class Dictionary<Value> {
    private int n;              // size
    private Node<Value> root;   // root of Dictionary
    ...
    public Dictionary withInitializedData(String urlString) {
    ...
    public static void main(String[] args) {
        ...
        Dictionary dictionary = Dictionary.getInstance().withInitializedData("https://users.cs.duke.edu/~ola/ap/linuxwords");
